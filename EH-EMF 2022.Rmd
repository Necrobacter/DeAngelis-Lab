...
<!-- MegCazSpp = Megan Comparison of CAZy annotated reads -->
<!-- MegKeggGeneralEnz = Megan Comparison of KEGG annotated reads Sorted by general metabolism With Previous node-->
<!-- MegKeggGeneralEnz2 = Megan Comparison of KEGG annotated reads Sorted by general metabolism without previous node -->
<!-- MegKeggGeneralEnzPws = Megan Comparison of KEGG annotated reads Sorted by general metabolic pathways without previous nodes-->
...
MegCazSpp <- read.csv("meg_caz_spp.csv")
MegKeggGeneralEnz <- read.csv("meg_keg_general_enz.csv")
MegKeggGeneralEnz2 <- read.csv("meg_keg_general_enz_2.csv")
MegKeggGeneralEnzPws <- read.csv("meg_keg_general_enz_3_pws.csv")
MegKeggSpp <- read.csv("meg_keg_spp.csv")
```
